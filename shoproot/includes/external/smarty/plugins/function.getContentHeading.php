...
// getContentHeading - (c) Copyright 2016 by Hetfield - www.MerZ-IT-SerVice.de
...
function smarty_function_getContentHeading($params, $smarty)
{
    if (isset($params['coID']) && $params['coID'] != '') {
        ...
        if (is_array($mits_shop_content_data) && count($mits_shop_content_data) > 0) {
            $heading = ($mits_shop_content_data['content_heading'] != '') ? $mits_shop_content_data['content_heading'] : $mits_shop_content_data['content_title'];
